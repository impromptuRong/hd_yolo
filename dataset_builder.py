...
TEST_IMAGE_FOLDER = "./data/NuCLS/evaluation_dataset_p_truth/rgbs"
TEST_GT_FOLDER = "./danyun_gt/NuCLS/evaluation_p_truth_multi_rater/results/processed_gt/output"

## Don't use this annotation
BLOOD_CELL_ANN_FILE = "./danyun_gt/NuCLS/corrected_single_rater/results/only_red_blood_bbox.csv"
BLOOD_CELLS = pd.read_csv(BLOOD_CELL_ANN_FILE, index_col=0)
BLOOD_CELLS = [(x['file'], np.array([x['x0'], x['y0'], x['x1'], x['y1']]), 'blood_cell') 
               for _, x in BLOOD_CELLS.iterrows()]
...
CLASSES_TRANSFER_MAP = {
    ...
    "blood_cell": "blood cell", "blood": "blood cell",
}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--format', choices=['yolo', 'coco', 'detectron2'], type=str)
